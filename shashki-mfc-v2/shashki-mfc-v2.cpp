...
// shashki-mfc-v2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cshashkimfcv2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание Cshashkimfcv2App

Cshashkimfcv2App::Cshashkimfcv2App()
{
...
// Единственный объект Cshashkimfcv2App

Cshashkimfcv2App theApp;


// Инициализация Cshashkimfcv2App

BOOL Cshashkimfcv2App::InitInstance()
{
